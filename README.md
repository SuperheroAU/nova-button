...
Default event: `SuperheroAU\NovaButton\Events\ButtonClick`.
...
The passed key refers to one of the classes defined in the [config file](https://github.com/superheroau/nova-button/blob/main/config/nova-button.php).
